...
const tests = [
  {
    ...
    serverTest: '/ban',
    serverCommand:
      '@msg-id=ban_success :tmi.twitch.tv NOTICE #local7000 :baduser',
    errorCommands: [
  ...
  },
  {
    ...
    serverTest: '#c0ffee',
    serverCommand:
      '@msg-id=color_changed :tmi.twitch.tv NOTICE #local7000 :#c0ffee',
    errorCommands: [
  ...
  },
  {
    ...
    serverCommand:
      '@msg-id=commercial_success :tmi.twitch.tv NOTICE #local7000 :30',
    errorCommands: [
  ...
  },
  {
    ...
    serverTest: '/commercial',
    serverCommand:
      '@msg-id=commercial_success :tmi.twitch.tv NOTICE #local7000 :60',
  },
  {
    command: 'emoteonly',
    inputParams: ['#local7000'],
  ...
  },
  {
    ...
    serverTest: '/host',
    serverCommand:
      '@msg-id=hosts_remaining :tmi.twitch.tv NOTICE #local7000 :5',
    errorCommands: [
  ...
  },
  {
    ...
    serverCommand:
      '@broadcaster-lang=;r9k=0;slow=300;subs-only=0 :tmi.twitch.tv ROOMSTATE #local7000',
    testTimeout: true,
  },
  {
    command: 'leave',
  ...
  },
  {
    ...
    serverTest: '/mod',
    serverCommand:
      '@msg-id=mod_success :tmi.twitch.tv NOTICE #local7000 :schmoopiie',
    errorCommands: [
  ...
  },
  {
    ...
    serverTest: '/mods',
    serverCommand:
      '@msg-id=room_mods :tmi.twitch.tv NOTICE #local7000 :The moderators of this room are: barry, baz',
    errorCommands: [
  ...
  },
  {
    ...
    serverTest: '/timeout',
    serverCommand:
      '@msg-id=timeout_success :tmi.twitch.tv NOTICE #local7000 :9000',
    errorCommands: [
  ...
  },
  {
    ...
    serverTest: '/timeout',
    serverCommand:
      '@msg-id=timeout_success :tmi.twitch.tv NOTICE #local7000 :300',
  },
  {
    command: 'unban',
    inputParams: ['#local7000', 'baduser'],
    ...
    serverTest: '/unban',
    serverCommand:
      '@msg-id=unban_success :tmi.twitch.tv NOTICE #local7000 :baduser',
    errorCommands: [
  ...
  },
  {
    ...
    serverTest: '/unban',
    serverCommand:
      '@msg-id=untimeout_success :tmi.twitch.tv NOTICE #local7000 :baduser',
  },
  {
    command: 'unhost',
    inputParams: ['#local7000'],
  ...
  },
  {
    ...
    serverTest: '/unmod',
    serverCommand:
      '@msg-id=unmod_success :tmi.twitch.tv NOTICE #local7000 :moddymcmodface',
    errorCommands: [
  ...
  },
  {
    ...
    serverTest: '/w',
    serverCommand:
      ':tmi.twitch.tv WHISPER moddymcmodface :You got unmodded! D:',
  },
];
...
describe('commands (identity)', () => {
    ...
    server.on('connection', ws => {
      ws.on('message', message => {
        if (~message.indexOf('Hello')) {
          ws.send(
            ':tmi.twitch.tv PRIVMSG #local7000 :\u0001ACTION Hello :)\u0001',
          );
        }
      });
    });
  ...
  it('should break up long messages (> 500 characters)', function(cb) {
    const client = this.client;
    const server = this.server;
    const lorem = `lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem
    ...
    server.on('connection', ws => {
      ws.on('message', message => {
        if (~message.indexOf('PRIVMSG')) {
          ws.send(
            `:tmi.twitch.tv PRIVMSG #local7000 : ${message.split(':')[1]}`,
          );
        }
      });
    });
