...
var Chat = /** @class */ (function (_super) {
    ...
    function Chat(options) {
        ...
        _this._handleConnect = function () {
            ...
            // Handle disconnects.
            _this._client.once(client_types_1.ClientEvents.DISCONNECTED, function () { return _this.emit(chat_types_1.DISCONNECT); });
            // Listen for reconnects.
            _this._client.once(client_types_1.ClientEvents.RECONNECT, function () { return _this.emit(chat_types_1.RECONNECT); });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        this.emit(chat_types_1.CONNECT);
                        return [3 /*break*/, 3];
                    case 2:
                        ...
                        this.emit(twitch_1.Events.ERROR_ENCOUNTERED, authenticationError);
        ...
        _this.on(chat_types_1.CONNECT, _this._handleConnect);
        _this.on(chat_types_1.DISCONNECT, _this._handleDisconnect);
        _this.on(chat_types_1.RECONNECT, _this._handleReconnect);
        return _this;
    }
    /**
     * Connect to Twitch.
    ...
    Chat.prototype.connect = function () {
        ...
        this._connectionInProgress = p_event_1.default(this, twitch_1.Events.CONNECTED, {
    ...
    Chat.prototype.disconnect = function () {
        ...
        var waitForDisconnectEvent = p_event_1.default(this, twitch_1.Events.DISCONNECTED);
        this._disconnectionInProgress = p_timeout_1.default(waitForDisconnectEvent, this._options.connectionTimeout, function () {
            waitForDisconnectEvent.cancel();
            Promise.resolve();
        });
        this.emit(chat_types_1.DISCONNECT);
        return this._disconnectionInProgress;
    };
    /**
    ...
    Chat.prototype.reconnect = function (options) {
        ...
        this._reconnectionInProgress = p_event_1.default(this, twitch_1.Events.CONNECTED, {
            timeout: this._options.connectionTimeout,
        });
        this.emit(chat_types_1.RECONNECT);
        return this._reconnectionInProgress;
    };
    /**
     * Join a channel.
    ...
    Chat.prototype._handleDisconnect = function () {
        ...
        this._readyState = chat_types_1.ChatReadyStates.DISCONNECTING;
        this._isAuthenticated = false;
        this._clearChannelState();
        (_a = this._client) === null || _a === void 0 ? void 0 : _a.once(client_types_1.ClientEvents.DISCONNECTED, function () {
            _this.emit(twitch_1.Events.DISCONNECTED);
            _this._readyState = chat_types_1.ChatReadyStates.DISCONNECTED;
            _this._log.info('disconnected');
        });
        (_b = this._client) === null || _b === void 0 ? void 0 : _b.disconnect();
    };
    Chat.prototype._handleReconnect = function () {
        var _this = this;
        var _a, _b, _c;
        this._log.info('reconnecting ...');
        this._readyState = chat_types_1.ChatReadyStates.RECONNECTING;
        (_a = this._client) === null || _a === void 0 ? void 0 : _a.removeAllListeners();
        (_b = this._client) === null || _b === void 0 ? void 0 : _b.once(twitch_1.Events.DISCONNECTED, function () {
            _this.emit(chat_types_1.CONNECT);
        });
        (_c = this._client) === null || _c === void 0 ? void 0 : _c.disconnect();
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        joinError_1 = _a.sent();
                        this._log.error(joinError_1, 'unable to rejoin channels');
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
