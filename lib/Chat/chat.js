...
var Chat = /** @class */ (function (_super) {
    ...
    function Chat(options) {
        ...
        _this.connect = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this._connectionInProgress) {
                    return [2 /*return*/, this._connectionInProgress];
                }
        ...
        _this._handleConnect = function () {
            ...
            var _a = _this._options, token = _a.token, username = _a.username;
            // Connect ...
            ...
            // Handle disconnects.
            _this._client.on(client_types_1.ClientEvents.DISCONNECTED, _this._handleClientDisconnect, _this);
            // Listen for reconnects.
            _this._client.once(client_types_1.ClientEvents.RECONNECT, function () { return _this.reconnect(); });
            ...
            _this._client.once(client_types_1.ClientEvents.CONNECTED, function (message) {
                if (token && username) {
                    _this._handleClientAuthenticated(message);
                }
    ...
    Chat.prototype.disconnect = function () {
        ...
        this._disconnectionInProgress = p_event_1.default(this, twitch_1.Events.DISCONNECTED, {
            timeout: this._options.connectionTimeout,
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, Promise.all(channels.map(function (channel) { return _this.join(channel); }))];
                }
            });
        });
    };
    ...
    Chat.prototype._handleClientDisconnect = function () {
        this._isAuthenticated = false;
        this._clearChannelState();
    };
    Chat.prototype._handleClientAuthenticated = function (message) {
